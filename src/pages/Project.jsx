        ...
        <Draggable axis="y" bounds="parent" handle=".handle" onDrag={onControlledDrag} position={controlledPosition} onStop={onControlledDragStop}>
            <div className={`${!maximize ? "w-3/5 h-4/5 max-md:w-9/12" : "w-full h-5/6"} flex flex-col shadow-2xl `} >
                ...
                <div className="flex flex-col items-center w-full h-full bg-white dark:bg-[#242424] rounded-b-lg p-2 overflow-auto ">
                    <Link to='https://github.com/pranjalbajpai23/whatsAmail' target="_blank" rel="noreferrence" className="max-md:hidden flex justify-center bg-white dark:bg-zinc-700/50 w-8/12"><img className="w-8/12" src="projectHeadImg.svg" alt="" /> </Link>
                    <div className="flex p-2 w-full justify-evenly flex-wrap ">
                        ...
                        <Link to="https://github.com/pranjalbajpai23/whatsAmail" target="_blank" rel="noreferrence" className="hidden max-md:block  flex flex-col items-center border border-black shadow-xl bg-slate-100 dark:bg-zinc-700/50 p-2 m-2 w-36 h-48 text-center">
                            <img className="w-24 h-28" src="projectHeadImg.svg" alt="" />
                            <span className="text-black dark:text-white">WhatsAmail</span>
                        </Link>
